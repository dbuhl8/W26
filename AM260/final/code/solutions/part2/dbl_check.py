...
if (debugging):
    ...
    fn_grid.append('../../slug_scripts/old_part2_fog/grid_rfw_fog_minmod_hll.dat')
    fn_slug.append('../../slug_scripts/part2_fog/slug_rfw_fog_minmod_hll_tot.dat')
    fn_slug.append('../../slug_scripts/old_part2_fog/slug_rfw_fog_minmod_hll_tot.dat')
sbplt_title = ['OLD FOG + HLL Baseline','NEW FOG + HLL Baseline']
...
plt.savefig('dbl_check_part2_baseline.png',dpi=800)
