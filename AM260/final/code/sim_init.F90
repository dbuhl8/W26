...
#include "definition.h"
  ...
  call read_initFileBool('slug.init','secondLoc',secondLoc)
  ...
  call read_initFileReal('slug.init','so_alpha' ,    so_alpha)
  call read_initFileReal('slug.init','so_freq'  ,    so_freq)
